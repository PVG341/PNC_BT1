...
#Hệ phương trình
hpt = tk.Label(frame_input, text="Phương trình bậc 1: ax + by = 0")
hpt.grid(row=0, column=1, padx=10, pady=5)

# Label và Entry cho hệ số a
so_a = tk.Label(frame_input, text="Hệ số a:")
so_a.grid(row=1, column=0, padx=5, pady=5)
...
so_b.grid(row=2, column=0, padx=5, pady=5)
